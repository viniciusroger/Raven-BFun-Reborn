...
public class BindComponent extends Component {
    ...
    public void render() {
        ...
        this.drawString(!this.moduleComponent.mod.canBeEnabled() && this.isBinding ? "Press a key..." : "Current bind: '§e" + (this.moduleComponent.mod.getKeycode() >= 1000 ? "M" + (this.moduleComponent.mod.getKeycode() - 1000) : Keyboard.getKeyName(this.moduleComponent.mod.getKeycode())) + "§r'");
        GL11.glPopMatrix();
    }
