...
public class Nametags extends Module {
    ...
    @EventTarget
    public void onRenderLiving(RenderNametag e) {
        if (e.getEntity() instanceof EntityPlayer && (e.getEntity() != mc.thePlayer || renderSelf.isToggled()) && ((EntityPlayer) e.getEntity()).deathTime == 0) {
